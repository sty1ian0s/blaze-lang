# Phase 4 – Ecosystem Crate: `blaze‑image`
...
- **Resize:** Scale an image by 2× nearest‑neighbour, verify pixel duplication.
- **Filters:** Apply a 3×3 box blur to a test pattern, compare with expected result.
