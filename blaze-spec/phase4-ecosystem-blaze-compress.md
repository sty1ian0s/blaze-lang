# Phase 4 – Ecosystem Crate: `blaze‑compress`
...
- **Streaming write/read:** Create a `CompressWriter<Vec<u8>>`, write chunks, finish, then create a `DecompressReader` over the result, read back, compare.
